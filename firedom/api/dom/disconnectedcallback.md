...
This function observes when the specified elements are removed from the document or given context. This is a convenience function for [`mutationCallback()`](/firedom/api/dom/mutationcallback.md)

## Import

```js
import disconnectedCallback from '@web-native-js/firedom/src/dom/disconnectedCallback.js';
```
